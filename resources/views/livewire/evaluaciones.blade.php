<div class="d-flex justify-content-between my-4">
    <div class="col-md-4">
        ...
        data-target="#addEvaluacion"><i class="far fa-lg fa-plus-square"></i> Nueva evaluacion</button>
    </div>
    <div class="col-md-4">
    ...
    <tbody>
        @foreach($evaluaciones as $evaluacion)
            <tr>
                ...
                data-target="#editEvaluacion" wire:click="edit({{$evaluacion->id}})"><i class="far fa-lg fa-edit"></i></button>
                <button class="btn btn-sm btn-sec" data-toggle="modal" data-target="#deleteEvaluacion" wire:click="delete({{$evaluacion->id}})"><i style="color:red "class="far fa-lg fa-trash-alt"></i></button></td>
...
<!-- Modal agregar  -->
<div wire:ignore.self class="modal fade" id="addEvaluacion" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    ...
    <!-- Modal Eliminar  -->
    <div wire:ignore.self class="modal fade" id="deleteEvaluacion" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-md modal-dialog-centered" role="document">
            <div class="modal-content">
            <div class="modal-header">
     ...
     <!-- Modal editar  -->
     <div wire:ignore.self class="modal fade" id="editEvaluacion" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-md modal-dialog-centered" role="document">
            <div class="modal-content">
            <div class="modal-header">
