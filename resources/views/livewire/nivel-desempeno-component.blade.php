    ...
    <div class="row">
        ...
        @elseif($rubrica->tipo_puntaje=="rango")
            <div class="col-sm-12" style="margin-top:4px">
                <small style="color:white">Mín. </small><input style="font-size:small"  step="0.01" title="Puntaje mínimo" type="number" min="0" wire:model="puntaje_minimo" class="input col-3 shadow-md">
                <small style="color:white">Máx. </small><input style="font-size:small" step="0.01" title="Puntaje máximo" type="number" min="0" wire:model="puntaje_maximo" class="input col-3 shadow-md">
                @if($nivel->ordenJerarquico>2)
                        <button class="btn btn-sm btn-danger" style="margin-top:-2px" wire:loading.attr="disabled" onclick="deleteNivel({{$id_nivel}})"><i class="fas fa-md fa-times"></i></button>
                @endif
                <div wire:loading>
